namespace basketBallBattleRoyale {
    ...
    export class EnemiesController extends fCore.ComponentScript {
        ...
        private movementSpeed: number = 1.4;
        private nearestDistance: number;
        ...
        private update = (): void => {
            ...
            if (this.targetedBall == undefined) return;
            this.moveToAvailableBalls();
            if (this.actualChosenBall == undefined) return;
            ...
            if (this.hasGrabbed) {
                ...
                if (distanceMag > 60)
                    this.actualChosenBall.getComponent(fCore.ComponentRigidbody).applyImpulseAtPoint(
                        new fCore.Vector3(enemyForward.x * this.throwStrength / 3, distanceMag * 5, enemyForward.z * this.throwStrength / 3),
        ...
        private checkNearestBall = (): void => {
            ...
            let counterOfBallsInUse: number = 0;
            ...
            if (counterOfBallsInUse == basketBalls.length - 3) {
